      ...
      <div className="mx-auto w-full max-w-5xl py-20 text-center lg:py-32">
        ...
        <div className="text-left">
          <ProjectCard
            ...
            image="/assets/images/paymongo.png"
          />
          ...
          <ProjectCard
            ...
            image="/assets/images/firstx.png"
          />
          <ProjectCard
            ...
            image="/assets/images/vinerahub.png"
          />
          <ProjectCard
            ...
            image="/assets/images/icomply.png"
          />
          <ProjectCard
            ...
            image="/assets/images/growtech.png"
          />
          <ProjectCard
            ...
            image="/assets/images/magkaisa.png"
          />
        </div>
      </div>
    </div>
